...
public class BlueAuto extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        aligning(new Pose2D(DistanceUnit.MM, 1432, -38.736, AngleUnit.RADIANS, -2.414));
        Thread.sleep(500);
        
        max = 0.45;
        intake.setPower(1);
        conveyer.setPower(1);
        aligning(new Pose2D(DistanceUnit.MM, 658.25, -739.7, AngleUnit.RADIANS, -2.414));
        Thread.sleep(500);
        intake.setPower(0);
        conveyer.setPower(0);
        max = 1;
        ...
        aligning(new Pose2D(DistanceUnit.MM, 755.173, 526.332, AngleUnit.RADIANS, -2.429));
    }
